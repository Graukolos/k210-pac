...
pub type R = crate::R<AlarmDateSpec>;
#[doc = "Register `alarm_date` writer"]
pub type W = crate::W<AlarmDateSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn week(&mut self) -> WeekW<AlarmDateSpec> {
        WeekW::new(self, 0)
    }
    #[doc = "Bits 8:12 - Day. Range \\[1,31\\]
or \\[1,30\\]
...
or \\[1,28\\]"]
    #[inline(always)]
    #[must_use]
    pub fn day(&mut self) -> DayW<AlarmDateSpec> {
        DayW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Month. Range \\[1,12\\]"]
    #[inline(always)]
    #[must_use]
    pub fn month(&mut self) -> MonthW<AlarmDateSpec> {
        MonthW::new(self, 16)
    }
    #[doc = "Bits 20:31 - Year. Range \\[0,99\\]"]
    #[inline(always)]
    #[must_use]
    pub fn year(&mut self) -> YearW<AlarmDateSpec> {
        YearW::new(self, 20)
    }
}
#[doc = "Alarm date information\n\nYou can [`read`](crate::Reg::read) this register and get [`alarm_date::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`alarm_date::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AlarmDateSpec;
impl crate::RegisterSpec for AlarmDateSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alarm_date::R`](R) reader structure"]
impl crate::Readable for AlarmDateSpec {}
#[doc = "`write(|w| ..)` method takes [`alarm_date::W`](W) writer structure"]
impl crate::Writable for AlarmDateSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets alarm_date to value 0"]
impl crate::Resettable for AlarmDateSpec {
