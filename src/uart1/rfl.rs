...
impl W {}
#[doc = "Receive FIFO Level\n\nYou can [`read`](crate::Reg::read) this register and get [`rfl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rfl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RflSpec;
...
impl crate::Writable for RflSpec {
