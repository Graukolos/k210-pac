...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_under(&mut self) -> RxUnderW<RawIntrStatSpec> {
        RxUnderW::new(self, 0)
    }
    #[doc = "Bit 1 - RX_OVER"]
    #[inline(always)]
    #[must_use]
    pub fn rx_over(&mut self) -> RxOverW<RawIntrStatSpec> {
        RxOverW::new(self, 1)
    }
    #[doc = "Bit 2 - RX_FULL"]
    #[inline(always)]
    #[must_use]
    pub fn rx_full(&mut self) -> RxFullW<RawIntrStatSpec> {
        RxFullW::new(self, 2)
    }
    #[doc = "Bit 3 - TX_OVER"]
    #[inline(always)]
    #[must_use]
    pub fn tx_over(&mut self) -> TxOverW<RawIntrStatSpec> {
        TxOverW::new(self, 3)
    }
    #[doc = "Bit 4 - TX_EMPTY"]
    #[inline(always)]
    #[must_use]
    pub fn tx_empty(&mut self) -> TxEmptyW<RawIntrStatSpec> {
        TxEmptyW::new(self, 4)
    }
    #[doc = "Bit 5 - RD_REQ"]
    #[inline(always)]
    #[must_use]
    pub fn rd_req(&mut self) -> RdReqW<RawIntrStatSpec> {
        RdReqW::new(self, 5)
    }
    #[doc = "Bit 6 - TX_ABRT"]
    #[inline(always)]
    #[must_use]
    pub fn tx_abrt(&mut self) -> TxAbrtW<RawIntrStatSpec> {
        TxAbrtW::new(self, 6)
    }
    #[doc = "Bit 7 - RX_DONE"]
    #[inline(always)]
    #[must_use]
    pub fn rx_done(&mut self) -> RxDoneW<RawIntrStatSpec> {
        RxDoneW::new(self, 7)
    }
    #[doc = "Bit 8 - ACTIVITY"]
    #[inline(always)]
    #[must_use]
    pub fn activity(&mut self) -> ActivityW<RawIntrStatSpec> {
        ActivityW::new(self, 8)
    }
    #[doc = "Bit 9 - STOP_DET"]
    #[inline(always)]
    #[must_use]
    pub fn stop_det(&mut self) -> StopDetW<RawIntrStatSpec> {
        StopDetW::new(self, 9)
    }
    #[doc = "Bit 10 - START_DET"]
    #[inline(always)]
    #[must_use]
    pub fn start_det(&mut self) -> StartDetW<RawIntrStatSpec> {
        StartDetW::new(self, 10)
    }
    #[doc = "Bit 11 - GEN_CALL"]
    #[inline(always)]
    #[must_use]
    pub fn gen_call(&mut self) -> GenCallW<RawIntrStatSpec> {
