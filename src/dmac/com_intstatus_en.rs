...
pub type R = crate::R<ComIntstatusEnSpec>;
#[doc = "Register `com_intstatus_en` writer"]
pub type W = crate::W<ComIntstatusEnSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slvif_dec_err(&mut self) -> SlvifDecErrW<ComIntstatusEnSpec> {
        SlvifDecErrW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave Interface Common Register Write to Read only Error"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_wr2ro_err(&mut self) -> SlvifWr2roErrW<ComIntstatusEnSpec> {
        SlvifWr2roErrW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave Interface Common Register Read to Write-only Error"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_rd2wo_err(&mut self) -> SlvifRd2woErrW<ComIntstatusEnSpec> {
        SlvifRd2woErrW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave Interface Common Register Write On Hold Error"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_wronhold_err(&mut self) -> SlvifWronholdErrW<ComIntstatusEnSpec> {
        SlvifWronholdErrW::new(self, 3)
    }
    #[doc = "Bit 8 - Slave Interface Undefined Register Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_undefinedreg_dec_err(&mut self) -> SlvifUndefinedregDecErrW<ComIntstatusEnSpec> {
        SlvifUndefinedregDecErrW::new(self, 8)
    }
}
#[doc = "Common Interrupt Status Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`com_intstatus_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`com_intstatus_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ComIntstatusEnSpec;
impl crate::RegisterSpec for ComIntstatusEnSpec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`com_intstatus_en::R`](R) reader structure"]
impl crate::Readable for ComIntstatusEnSpec {}
#[doc = "`write(|w| ..)` method takes [`com_intstatus_en::W`](W) writer structure"]
impl crate::Writable for ComIntstatusEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets com_intstatus_en to value 0"]
impl crate::Resettable for ComIntstatusEnSpec {
