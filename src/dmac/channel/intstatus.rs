...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn block_tfr_done(&mut self) -> BlockTfrDoneW<IntstatusSpec> {
        BlockTfrDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer done"]
    #[inline(always)]
    #[must_use]
    pub fn tfr_done(&mut self) -> TfrDoneW<IntstatusSpec> {
        TfrDoneW::new(self, 1)
    }
    #[doc = "Bit 3 - Source transaction complete"]
    #[inline(always)]
    #[must_use]
    pub fn src_transcomp(&mut self) -> SrcTranscompW<IntstatusSpec> {
        SrcTranscompW::new(self, 3)
    }
    #[doc = "Bit 4 - Destination transaction complete"]
    #[inline(always)]
    #[must_use]
    pub fn dst_transcomp(&mut self) -> DstTranscompW<IntstatusSpec> {
        DstTranscompW::new(self, 4)
    }
    #[doc = "Bit 5 - Source Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn src_dec_err(&mut self) -> SrcDecErrW<IntstatusSpec> {
        SrcDecErrW::new(self, 5)
    }
    #[doc = "Bit 6 - Destination Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn dst_dec_err(&mut self) -> DstDecErrW<IntstatusSpec> {
        DstDecErrW::new(self, 6)
    }
    #[doc = "Bit 7 - Source Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn src_slv_err(&mut self) -> SrcSlvErrW<IntstatusSpec> {
        SrcSlvErrW::new(self, 7)
    }
    #[doc = "Bit 8 - Destination Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn dst_slv_err(&mut self) -> DstSlvErrW<IntstatusSpec> {
        DstSlvErrW::new(self, 8)
    }
    #[doc = "Bit 9 - LLI Read Decode Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lli_rd_dec_err(&mut self) -> LliRdDecErrW<IntstatusSpec> {
        LliRdDecErrW::new(self, 9)
    }
    #[doc = "Bit 10 - LLI WRITE Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn lli_wr_dec_err(&mut self) -> LliWrDecErrW<IntstatusSpec> {
        LliWrDecErrW::new(self, 10)
    }
    #[doc = "Bit 11 - LLI Read Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn lli_rd_slv_err(&mut self) -> LliRdSlvErrW<IntstatusSpec> {
        LliRdSlvErrW::new(self, 11)
    }
    #[doc = "Bit 12 - LLI WRITE Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn lli_wr_slv_err(&mut self) -> LliWrSlvErrW<IntstatusSpec> {
