...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn block_tfr_done(&mut self) -> BlockTfrDoneW<IntclearSpec> {
        BlockTfrDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer done"]
    #[inline(always)]
    #[must_use]
    pub fn tfr_done(&mut self) -> TfrDoneW<IntclearSpec> {
        TfrDoneW::new(self, 1)
    }
    #[doc = "Bit 3 - Source transaction complete"]
    #[inline(always)]
    #[must_use]
    pub fn src_transcomp(&mut self) -> SrcTranscompW<IntclearSpec> {
        SrcTranscompW::new(self, 3)
    }
    #[doc = "Bit 4 - Destination transaction complete"]
    #[inline(always)]
    #[must_use]
    pub fn dst_transcomp(&mut self) -> DstTranscompW<IntclearSpec> {
        DstTranscompW::new(self, 4)
    }
    #[doc = "Bit 5 - Source Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn src_dec_err(&mut self) -> SrcDecErrW<IntclearSpec> {
        SrcDecErrW::new(self, 5)
    }
    #[doc = "Bit 6 - Destination Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn dst_dec_err(&mut self) -> DstDecErrW<IntclearSpec> {
        DstDecErrW::new(self, 6)
    }
    #[doc = "Bit 7 - Source Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn src_slv_err(&mut self) -> SrcSlvErrW<IntclearSpec> {
        SrcSlvErrW::new(self, 7)
    }
    #[doc = "Bit 8 - Destination Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn dst_slv_err(&mut self) -> DstSlvErrW<IntclearSpec> {
        DstSlvErrW::new(self, 8)
    }
    #[doc = "Bit 9 - LLI Read Decode Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lli_rd_dec_err(&mut self) -> LliRdDecErrW<IntclearSpec> {
        LliRdDecErrW::new(self, 9)
    }
    #[doc = "Bit 10 - LLI WRITE Decode Error"]
    #[inline(always)]
    #[must_use]
    pub fn lli_wr_dec_err(&mut self) -> LliWrDecErrW<IntclearSpec> {
        LliWrDecErrW::new(self, 10)
    }
    #[doc = "Bit 11 - LLI Read Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn lli_rd_slv_err(&mut self) -> LliRdSlvErrW<IntclearSpec> {
        LliRdSlvErrW::new(self, 11)
    }
    #[doc = "Bit 12 - LLI WRITE Slave Error"]
    #[inline(always)]
    #[must_use]
    pub fn lli_wr_slv_err(&mut self) -> LliWrSlvErrW<IntclearSpec> {
        LliWrSlvErrW::new(self, 12)
    }
}
#[doc = "Interrupt Clear Register\n\nYou can [`read`](crate::Reg::read) this register and get [`intclear::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`intclear::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
