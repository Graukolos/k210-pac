...
pub type R = crate::R<Pll2Spec>;
#[doc = "Register `pll2` writer"]
pub type W = crate::W<Pll2Spec>;
...
pub type CkinSelR = crate::FieldReader;
#[doc = "Field `ckin_sel` writer - "]
pub type CkinSelW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    ...
    #[doc = "Bits 26:27"]
    #[inline(always)]
    pub fn ckin_sel(&self) -> CkinSelR {
        CkinSelR::new(((self.bits >> 26) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    #[must_use]
    pub fn clkr(&mut self) -> ClkrW<Pll2Spec> {
        ClkrW::new(self, 0)
    }
    #[doc = "Bits 4:9"]
    #[inline(always)]
    #[must_use]
    pub fn clkf(&mut self) -> ClkfW<Pll2Spec> {
        ClkfW::new(self, 4)
    }
    #[doc = "Bits 10:13"]
    #[inline(always)]
    #[must_use]
    pub fn clkod(&mut self) -> ClkodW<Pll2Spec> {
        ClkodW::new(self, 10)
    }
    #[doc = "Bits 14:19"]
    #[inline(always)]
    #[must_use]
    pub fn bwadj(&mut self) -> BwadjW<Pll2Spec> {
        BwadjW::new(self, 14)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<Pll2Spec> {
        ResetW::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn pwrd(&mut self) -> PwrdW<Pll2Spec> {
        PwrdW::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn intfb(&mut self) -> IntfbW<Pll2Spec> {
        IntfbW::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn bypass(&mut self) -> BypassW<Pll2Spec> {
        BypassW::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn test(&mut self) -> TestW<Pll2Spec> {
        TestW::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn out_en(&mut self) -> OutEnW<Pll2Spec> {
        OutEnW::new(self, 25)
    }
    #[doc = "Bits 26:27"]
    #[inline(always)]
    #[must_use]
    pub fn ckin_sel(&mut self) -> CkinSelW<Pll2Spec> {
        CkinSelW::new(self, 26)
    }
}
#[doc = "PLL2 controller\n\nYou can [`read`](crate::Reg::read) this register and get [`pll2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pll2Spec;
impl crate::RegisterSpec for Pll2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll2::R`](R) reader structure"]
impl crate::Readable for Pll2Spec {}
#[doc = "`write(|w| ..)` method takes [`pll2::W`](W) writer structure"]
impl crate::Writable for Pll2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets pll2 to value 0"]
impl crate::Resettable for Pll2Spec {
