...
pub type R = crate::R<OutputXorSpec>;
#[doc = "Register `output_xor` writer"]
pub type W = crate::W<OutputXorSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin(&mut self, n: u8) -> PinW<OutputXorSpec> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        PinW::new(self, n)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin0(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 1 - pin1"]
    #[inline(always)]
    #[must_use]
    pub fn pin1(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 1)
    }
    #[doc = "Bit 2 - pin2"]
    #[inline(always)]
    #[must_use]
    pub fn pin2(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 2)
    }
    #[doc = "Bit 3 - pin3"]
    #[inline(always)]
    #[must_use]
    pub fn pin3(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 3)
    }
    #[doc = "Bit 4 - pin4"]
    #[inline(always)]
    #[must_use]
    pub fn pin4(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 4)
    }
    #[doc = "Bit 5 - pin5"]
    #[inline(always)]
    #[must_use]
    pub fn pin5(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 5)
    }
    #[doc = "Bit 6 - pin6"]
    #[inline(always)]
    #[must_use]
    pub fn pin6(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 6)
    }
    #[doc = "Bit 7 - pin7"]
    #[inline(always)]
    #[must_use]
    pub fn pin7(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 7)
    }
    #[doc = "Bit 8 - pin8"]
    #[inline(always)]
    #[must_use]
    pub fn pin8(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 8)
    }
    #[doc = "Bit 9 - pin9"]
    #[inline(always)]
    #[must_use]
    pub fn pin9(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 9)
    }
    #[doc = "Bit 10 - pin10"]
    #[inline(always)]
    #[must_use]
    pub fn pin10(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 10)
    }
    #[doc = "Bit 11 - pin11"]
    #[inline(always)]
    #[must_use]
    pub fn pin11(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 11)
    }
    #[doc = "Bit 12 - pin12"]
    #[inline(always)]
    #[must_use]
    pub fn pin12(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 12)
    }
    #[doc = "Bit 13 - pin13"]
    #[inline(always)]
    #[must_use]
    pub fn pin13(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 13)
    }
    #[doc = "Bit 14 - pin14"]
    #[inline(always)]
    #[must_use]
    pub fn pin14(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 14)
    }
    #[doc = "Bit 15 - pin15"]
    #[inline(always)]
    #[must_use]
    pub fn pin15(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 15)
    }
    #[doc = "Bit 16 - pin16"]
    #[inline(always)]
    #[must_use]
    pub fn pin16(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 16)
    }
    #[doc = "Bit 17 - pin17"]
    #[inline(always)]
    #[must_use]
    pub fn pin17(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 17)
    }
    #[doc = "Bit 18 - pin18"]
    #[inline(always)]
    #[must_use]
    pub fn pin18(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 18)
    }
    #[doc = "Bit 19 - pin19"]
    #[inline(always)]
    #[must_use]
    pub fn pin19(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 19)
    }
    #[doc = "Bit 20 - pin20"]
    #[inline(always)]
    #[must_use]
    pub fn pin20(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 20)
    }
    #[doc = "Bit 21 - pin21"]
    #[inline(always)]
    #[must_use]
    pub fn pin21(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 21)
    }
    #[doc = "Bit 22 - pin22"]
    #[inline(always)]
    #[must_use]
    pub fn pin22(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 22)
    }
    #[doc = "Bit 23 - pin23"]
    #[inline(always)]
    #[must_use]
    pub fn pin23(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 23)
    }
    #[doc = "Bit 24 - pin24"]
    #[inline(always)]
    #[must_use]
    pub fn pin24(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 24)
    }
    #[doc = "Bit 25 - pin25"]
    #[inline(always)]
    #[must_use]
    pub fn pin25(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 25)
    }
    #[doc = "Bit 26 - pin26"]
    #[inline(always)]
    #[must_use]
    pub fn pin26(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 26)
    }
    #[doc = "Bit 27 - pin27"]
    #[inline(always)]
    #[must_use]
    pub fn pin27(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 27)
    }
    #[doc = "Bit 28 - pin28"]
    #[inline(always)]
    #[must_use]
    pub fn pin28(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 28)
    }
    #[doc = "Bit 29 - pin29"]
    #[inline(always)]
    #[must_use]
    pub fn pin29(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 29)
    }
    #[doc = "Bit 30 - pin30"]
    #[inline(always)]
    #[must_use]
    pub fn pin30(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 30)
    }
    #[doc = "Bit 31 - pin31"]
    #[inline(always)]
    #[must_use]
    pub fn pin31(&mut self) -> PinW<OutputXorSpec> {
        PinW::new(self, 31)
    }
}
#[doc = "Output XOR (invert) Register\n\nYou can [`read`](crate::Reg::read) this register and get [`output_xor::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`output_xor::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OutputXorSpec;
impl crate::RegisterSpec for OutputXorSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`output_xor::R`](R) reader structure"]
impl crate::Readable for OutputXorSpec {}
#[doc = "`write(|w| ..)` method takes [`output_xor::W`](W) writer structure"]
impl crate::Writable for OutputXorSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets output_xor to value 0"]
impl crate::Resettable for OutputXorSpec {
