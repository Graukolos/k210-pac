...
pub type R = crate::R<PreFir1CoefSpec>;
#[doc = "Register `pre_fir1_coef[%s]` writer"]
pub type W = crate::W<PreFir1CoefSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tap0(&mut self) -> Tap0W<PreFir1CoefSpec> {
        Tap0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Tap 1"]
    #[inline(always)]
    #[must_use]
    pub fn tap1(&mut self) -> Tap1W<PreFir1CoefSpec> {
        Tap1W::new(self, 16)
    }
}
#[doc = "FIR1 pre-filter coeffecients\n\nYou can [`read`](crate::Reg::read) this register and get [`pre_fir1_coef::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pre_fir1_coef::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PreFir1CoefSpec;
impl crate::RegisterSpec for PreFir1CoefSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pre_fir1_coef::R`](R) reader structure"]
impl crate::Readable for PreFir1CoefSpec {}
#[doc = "`write(|w| ..)` method takes [`pre_fir1_coef::W`](W) writer structure"]
impl crate::Writable for PreFir1CoefSpec {
...
to value 0"]
impl crate::Resettable for PreFir1CoefSpec {
