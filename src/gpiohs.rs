...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn pullup_en(&self) -> &PullupEn {
        &self.pullup_en
    }
...
pub mod output_en;
#[doc = "output_val (rw) register accessor: Output Value Register\n\nYou can [`read`](crate::Reg::read) this register and get [`output_val::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`output_val::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@output_val`]
module"]
#[doc(alias = "output_val")]
pub type OutputVal = crate::Reg<output_val::OutputValSpec>;
#[doc = "Output Value Register"]
pub mod output_val;
#[doc = "pullup_en (rw) register accessor: Internal Pull-Up Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pullup_en::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pullup_en::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pullup_en`]
module"]
#[doc(alias = "pullup_en")]
pub type PullupEn = crate::Reg<pullup_en::PullupEnSpec>;
...
pub mod iof_sel;
#[doc = "output_xor (rw) register accessor: Output XOR (invert) Register\n\nYou can [`read`](crate::Reg::read) this register and get [`output_xor::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`output_xor::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@output_xor`]
module"]
#[doc(alias = "output_xor")]
pub type OutputXor = crate::Reg<output_xor::OutputXorSpec>;
